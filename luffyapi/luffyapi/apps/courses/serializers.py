...
class CourseDetailModelSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Course
        fields = ["id", "name", "course_img", "course_video", "students", "lessons", "pub_lessons", "price", "real_price", "discount_name", "active_time", "teacher", "real_brief", "level_name", "chapter_list"]