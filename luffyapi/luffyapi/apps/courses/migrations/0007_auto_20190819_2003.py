...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('courses', '0006_auto_20190819_1659'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_expire', to='courses.Course', verbose_name='课程有效期'),
        ),
        migrations.CreateModel(
            name='PriceDiscount',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updated_time', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
                ('active', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='activecourses', to='courses.Activity', verbose_name='活动')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='activeprices', to='courses.Course', verbose_name='课程')),
                ('discount', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='discountcourse', to='courses.PriceDiscount', verbose_name='优惠折扣')),
            ],
            options={
